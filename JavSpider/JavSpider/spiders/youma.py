...
class YoumaSpider(scrapy.Spider):
    name = 'youma'
    allowed_domains = ['xwb2uooia5o59avwxb.com']
    start_urls = ['https://www.xwb2uooia5o59avwxb.com']
    headers = {
    ...
    def parse(self, response):
        ...
        li_list = response.xpath("//div[@id='waterfall']/div")
        for li in li_list:
            item = JavspiderItem()
        ...
        #找到下一页的url地址
        next_url = response.xpath('/html/body//div/ul/li/a[@id="next"]/@href').extract_first()
        # print(next_url)
    ...
    def parse_detail1(self, response):
        ...
        # print(movie_id)
        yield scrapy.Request(
            'https://www.xwb2uooia5o59avwxb.com/ajax/uncledatoolsbyajax.php?gid=%s&lang=zh&uc=0' % movie_id,

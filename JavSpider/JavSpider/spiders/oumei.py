...
class OumeiSpider(scrapy.Spider):
    name = 'oumei'
    allowed_domains = ['javbus.work']
    start_urls = ['https://www.javbus.work/']
    headers = {
    ...
    def parse(self, response):
        ...
        if next_url is not None:
            next_url = 'https://www.javbus.work' + next_url
            print(next_url)
    ...
    def parse_detail1(self, response):
        ...
        # print(movie_id)
        yield scrapy.Request(
            'https://www.javbus.work/ajax/uncledatoolsbyajax.php?gid=%s&lang=zh&uc=1' % movie_id,
